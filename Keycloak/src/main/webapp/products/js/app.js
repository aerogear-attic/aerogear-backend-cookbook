...
angular.element(document).ready(function ($http) {
    ...
    keycloakAuth.init({ onLoad: 'login-required' }).success(function () {
        ...
        auth.logoutUrl = keycloakAuth.authServerUrl + "/realms/keycloak/tokens/logout?redirect_uri=/keycloak/products/index.html";
...
module.controller('GlobalCtrl', function($scope, $http) {
    ...
    $scope.reloadData = function() {
        $http.get("/keycloak/rest/products").success(function(data) {
